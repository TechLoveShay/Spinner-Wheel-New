...
export default function SpinnerWheel() {
  ...
  const spinWheel = () => {
    ...
    setTimeout(() => {
      setSpinning(false);
      const selectedIndex = Math.floor(((360 - (newRotation % 360)) / 45) % 8); // Fixed closing parenthesis
      ...
      <div className="relative w-80 h-80 mb-8">
        ...
        >
          {options.map((option, index) => (
            ...
            >
              <div className="absolute top-[25%] left-[75%] transform -translate-x-1/2 -translate-y-1/2">
